...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO users (fullname, username, userProfile, email, reset_token, phone_no, id_no, religion, gender, reg_no, dateofbirth, password, admin) VALUES ('$fullname', '$username', '$image_name', '$email', '', '$phone_no', '$id_no', '$religion', '$gender', '$reg_no', '$dateofbirth', '$password', 'no')";
